...
namespace Services
{
    public class RabbitMqSetup
    {
        ...
        public void Initialize()
        {
            ...
            channel.QueueBind(queue: "orders_queue", exchange: "system_exchange", routingKey: "order.created");
            channel.QueueBind(queue: "payments_queue", exchange: "system_exchange", routingKey: "payment.success");
            channel.QueueBind(queue: "email_queue", exchange: "system_exchange", routingKey: "email.success");
            channel.QueueBind(queue: "redis_queue", exchange: "system_exchange", routingKey: "redis.update");
        }
    }
}
